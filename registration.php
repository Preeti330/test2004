...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Perform validation for required fields, email format, and password match
    if (empty($first_name) || empty($last_name) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        // Perform validation for password complexity
        ...
        if (!preg_match($passwordRegex, $password)) {
            ...
            $sql = "UPDATE customer
            SET first_name='$first_name',last_name='$last_name',password='$hashed_password',created_at=DATE('YYYY-MM-dd ')
            WHERE email='$email'";
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-container">
                    <h2 class="mb-3 inputfeild">Register</h2>
